...
const Footer: React.FC = () => {
  ...
  const socialLinks = [
    {
      name: 'X/Twitter',
      href: 'https://twitter.com/framecoach',
      icon: (
    ...
    {
      name: 'Instagram',
      href: 'https://instagram.com/framecoach',
      icon: (
        <svg className="w-5 h-5" fill="currentColor" viewBox="0 0 24 24" aria-hidden="true">
    ...
    {
      name: 'YouTube',
      href: 'https://youtube.com/@framecoach',
      icon: (
        <svg className="w-5 h-5" fill="currentColor" viewBox="0 0 24 24" aria-hidden="true">
    ...
    {
      name: 'TikTok',
      href: 'https://tiktok.com/@framecoach',
      icon: (
        <svg className="w-5 h-5" fill="currentColor" viewBox="0 0 24 24" aria-hidden="true">
  ...
  return (
    <footer className="relative bg-shadow border-t border-white/5 overflow-hidden">
      <div className="max-w-9/10 mx-auto px-4 sm:px-6 lg:px-8">
              ...
              <ul className="space-y-3">
                {productLinks.map((link) => (
                  <li key={link.label}>
                    <a
                      href={link.href}
                      className="text-alabaster hover:text-white transition-colors duration-200 text-sm"
                    >
                      {link.label}
                    </a>
                  </li>
        ...
        {/* Middle Section - Social & Tagline */}
        <div className="flex flex-col sm:flex-row justify-between items-center gap-6 pb-4">
          {/* Social Icons */}
          <div className="flex items-center gap-5">
            {socialLinks.map((social) => (
              <a
                key={social.name}
                href={social.href}
                className="text-alabaster/50 hover:text-scarlet transition-colors duration-200"
